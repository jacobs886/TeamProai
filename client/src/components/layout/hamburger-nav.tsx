  ...
  const aiFeatures: NavSection[] = [
    {
      ...
      items: [
        { title: "Smart Chatbots", icon: Bot, href: "/ai/chatbots", description: "Automated responses", isNew: true, isPremium: true },
        { title: "Message Analysis", icon: Brain, href: "/ai/sentiment", description: "Urgency detection", isPremium: true },
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Player Development", icon: TrendingUp, href: "/development", description: "Growth tracking" },
